...
public class VectorXY {
    ...
    public void addVector (final double x, final double y) {
        this.x += x;
        this.y += y;
    }
    public void addVector (final VectorXY vector) {
    ...
    public void subVector (final double x, final double y) {
        this.addVector(-x, -y);
    }
    public void subVector (final VectorXY vector) {
        this.subVector(vector.x, vector.y);
    }
    public VectorXY diffVector (final VectorXY vector1, final VectorXY vector2) {
        return new VectorXY (vector1.x - vector2.x, vector1.y - vector2.y);
    }
    public void mulVector (final double n) {
        this.x *= n;
        this.y *= n;
    }
    ...
    public void divVector (double n) {
        if (n != 0) {
            this.x /= n;
            this.y /= n;
        } else {
    ...
    public VectorXY multiply(double var1) {
        return new VectorXY(this.getX() * var1, this.getY() * var1);
    }
